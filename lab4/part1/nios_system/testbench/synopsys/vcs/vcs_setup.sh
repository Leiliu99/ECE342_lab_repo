...
vcs -lca -timescale=1ps/1ps -sverilog +verilog2001ext+.v -ntb_opts dtm $ELAB_OPTIONS $USER_DEFINED_ELAB_OPTIONS \
  ...
  $QSYS_SIMDIR/nios_system_tb/simulation/submodules/nios_system_nios2_gen2_0_cpu.v \
  $QSYS_SIMDIR/nios_system_tb/simulation/submodules/nios_system_nios2_gen2_0_cpu_debug_slave_sysclk.v \
  $QSYS_SIMDIR/nios_system_tb/simulation/submodules/nios_system_nios2_gen2_0_cpu_debug_slave_tck.v \
  $QSYS_SIMDIR/nios_system_tb/simulation/submodules/nios_system_nios2_gen2_0_cpu_debug_slave_wrapper.v \
  $QSYS_SIMDIR/nios_system_tb/simulation/submodules/nios_system_nios2_gen2_0_cpu_test_bench.v \
  ...
  $QSYS_SIMDIR/nios_system_tb/simulation/submodules/nios_system_switches.v \
  $QSYS_SIMDIR/nios_system_tb/simulation/submodules/nios_system_onchip_memory2_0.v \
  $QSYS_SIMDIR/nios_system_tb/simulation/submodules/nios_system_nios2_gen2_0.v \
  $QSYS_SIMDIR/nios_system_tb/simulation/submodules/nios_system_leds.v \
  $QSYS_SIMDIR/nios_system_tb/simulation/submodules/altera_conduit_bfm_0002.sv \
  $QSYS_SIMDIR/nios_system_tb/simulation/submodules/altera_avalon_reset_source.sv \
  $QSYS_SIMDIR/nios_system_tb/simulation/submodules/altera_conduit_bfm.sv \

...
module nios_system_mm_interconnect_0 (
	...
	wire   [3:0] cmd_mux_src_channel;                                                                // cmd_mux:src_channel -> nios2_gen2_0_debug_mem_slave_agent:cp_channel
	...
	wire  [15:0] switches_s1_agent_m0_address;                                                       // switches_s1_agent:m0_address -> switches_s1_translator:uav_address
	...
	wire         cmd_mux_001_src_valid;                                                              // cmd_mux_001:src_valid -> switches_s1_agent:cp_valid
	wire  [89:0] cmd_mux_001_src_data;                                                               // cmd_mux_001:src_data -> switches_s1_agent:cp_data
	wire         cmd_mux_001_src_ready;                                                              // switches_s1_agent:cp_ready -> cmd_mux_001:src_ready
	wire   [3:0] cmd_mux_001_src_channel;                                                            // cmd_mux_001:src_channel -> switches_s1_agent:cp_channel
	wire         cmd_mux_001_src_startofpacket;                                                      // cmd_mux_001:src_startofpacket -> switches_s1_agent:cp_startofpacket
	wire         cmd_mux_001_src_endofpacket;                                                        // cmd_mux_001:src_endofpacket -> switches_s1_agent:cp_endofpacket
	...
	wire  [89:0] cmd_mux_002_src_data;                                                               // cmd_mux_002:src_data -> leds_s1_agent:cp_data
	wire         cmd_mux_002_src_ready;                                                              // leds_s1_agent:cp_ready -> cmd_mux_002:src_ready
	wire   [3:0] cmd_mux_002_src_channel;                                                            // cmd_mux_002:src_channel -> leds_s1_agent:cp_channel
	...
	wire  [89:0] cmd_mux_003_src_data;                                                               // cmd_mux_003:src_data -> onchip_memory2_0_s1_agent:cp_data
	...
	wire         switches_s1_agent_rp_valid;                                                         // switches_s1_agent:rp_valid -> router_003:sink_valid
	wire  [89:0] switches_s1_agent_rp_data;                                                          // switches_s1_agent:rp_data -> router_003:sink_data
	wire         switches_s1_agent_rp_ready;                                                         // router_003:sink_ready -> switches_s1_agent:rp_ready
	wire         switches_s1_agent_rp_startofpacket;                                                 // switches_s1_agent:rp_startofpacket -> router_003:sink_startofpacket
	wire         switches_s1_agent_rp_endofpacket;                                                   // switches_s1_agent:rp_endofpacket -> router_003:sink_endofpacket
	...
	wire  [89:0] leds_s1_agent_rp_data;                                                              // leds_s1_agent:rp_data -> router_004:sink_data
	...
	wire  [89:0] onchip_memory2_0_s1_agent_rp_data;                                                  // onchip_memory2_0_s1_agent:rp_data -> router_005:sink_data
	...
	wire  [89:0] cmd_demux_001_src1_data;                                                            // cmd_demux_001:src1_data -> cmd_mux_003:sink1_data
	...
	wire  [89:0] rsp_demux_003_src1_data;                                                            // rsp_demux_003:src1_data -> rsp_mux_001:sink1_data
	...
	wire         switches_s1_agent_rdata_fifo_src_valid;                                             // switches_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_001:in_0_valid
	wire  [33:0] switches_s1_agent_rdata_fifo_src_data;                                              // switches_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_001:in_0_data
	wire         switches_s1_agent_rdata_fifo_src_ready;                                             // avalon_st_adapter_001:in_0_ready -> switches_s1_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_001_out_0_valid;                                                  // avalon_st_adapter_001:out_0_valid -> switches_s1_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_001_out_0_data;                                                   // avalon_st_adapter_001:out_0_data -> switches_s1_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_001_out_0_ready;                                                  // switches_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_001:out_0_ready
	wire   [0:0] avalon_st_adapter_001_out_0_error;                                                  // avalon_st_adapter_001:out_0_error -> switches_s1_agent:rdata_fifo_sink_error

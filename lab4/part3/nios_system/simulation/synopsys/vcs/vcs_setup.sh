...
vcs -lca -timescale=1ps/1ps -sverilog +verilog2001ext+.v -ntb_opts dtm $ELAB_OPTIONS $USER_DEFINED_ELAB_OPTIONS \
  ...
  $QSYS_SIMDIR/submodules/nios_system_nios2_gen2_0_cpu.v \
  $QSYS_SIMDIR/submodules/nios_system_nios2_gen2_0_cpu_debug_slave_sysclk.v \
  $QSYS_SIMDIR/submodules/nios_system_nios2_gen2_0_cpu_debug_slave_tck.v \
  $QSYS_SIMDIR/submodules/nios_system_nios2_gen2_0_cpu_debug_slave_wrapper.v \
  $QSYS_SIMDIR/submodules/nios_system_nios2_gen2_0_cpu_test_bench.v \
  ...
  $QSYS_SIMDIR/submodules/nios_system_nios2_gen2_0.v \
  $QSYS_SIMDIR/submodules/avalon_fp_mult.sv \
  $QSYS_SIMDIR/submodules/avalon_slave.sv \
  $QSYS_SIMDIR/submodules/fp_mult.v \

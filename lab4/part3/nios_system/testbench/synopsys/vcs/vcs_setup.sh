...
vcs -lca -timescale=1ps/1ps -sverilog +verilog2001ext+.v -ntb_opts dtm $ELAB_OPTIONS $USER_DEFINED_ELAB_OPTIONS \
  ...
  $QSYS_SIMDIR/nios_system_tb/simulation/submodules/avalon_fp_mult.sv \
  $QSYS_SIMDIR/nios_system_tb/simulation/submodules/avalon_slave.sv \
  $QSYS_SIMDIR/nios_system_tb/simulation/submodules/fp_mult.v \
